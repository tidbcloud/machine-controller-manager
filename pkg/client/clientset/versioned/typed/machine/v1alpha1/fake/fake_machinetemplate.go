...
func (c *FakeMachineTemplates) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.MachineTemplate, err error) {
	obj, err := c.Fake.
...
func (c *FakeMachineTemplates) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MachineTemplateList, err error) {
	obj, err := c.Fake.
...
func (c *FakeMachineTemplates) Create(ctx context.Context, machineTemplate *v1alpha1.MachineTemplate, opts v1.CreateOptions) (result *v1alpha1.MachineTemplate, err error) {
	obj, err := c.Fake.
...
func (c *FakeMachineTemplates) Update(ctx context.Context, machineTemplate *v1alpha1.MachineTemplate, opts v1.UpdateOptions) (result *v1alpha1.MachineTemplate, err error) {
	obj, err := c.Fake.
...
func (c *FakeMachineTemplates) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.MachineTemplate, err error) {
	obj, err := c.Fake.
