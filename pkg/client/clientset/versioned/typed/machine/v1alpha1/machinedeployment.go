...
type MachineDeploymentInterface interface {
	...
	GetScale(ctx context.Context, machineDeploymentName string, options v1.GetOptions) (*v1alpha1.Scale, error)
	UpdateScale(ctx context.Context, machineDeploymentName string, scale *v1alpha1.Scale, opts v1.UpdateOptions) (*v1alpha1.Scale, error)
...
func (c *machineDeployments) GetScale(ctx context.Context, machineDeploymentName string, options v1.GetOptions) (result *v1alpha1.Scale, err error) {
...
func (c *machineDeployments) UpdateScale(ctx context.Context, machineDeploymentName string, scale *v1alpha1.Scale, opts v1.UpdateOptions) (result *v1alpha1.Scale, err error) {
	result = &v1alpha1.Scale{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("machinedeployments").
